...
!!! info "How to read this page"
    ...
    - **Activity** — verified from the latest data date in the committed archive
...
*Counts and dates verified 2026-08-24 against the working tree: `cdc_open`
...
committed data dates sampled from the archived CSVs.*
