...
Loads the bundled snapshot at data/raw/seer/var_formats.json. Refresh with
`uv run python -m seer.download` if SEER adds/renames sites.
"""
...
_CATALOG_PATH = (
    Path(__file__).parent.parent.parent / "data" / "raw" / "seer" / "var_formats.json"
)
