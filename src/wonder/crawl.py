...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("data/raw/wonder/link_harvest.log"),
    ],
)
...
def write_csv(rows: list[dict], out_path: str = "data/raw/wonder/links.csv") -> None:
    if not rows:
...
def main():
    ...
    write_csv(rows, "data/raw/wonder/links.csv")
